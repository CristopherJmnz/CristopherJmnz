...
export const ACTIONS = [
  { kind: "link", href: "https://www.linkedin.com/in/cristopher-jimenez-jimenez/", icon: "fab fa-linkedin", label: "LinkedIn" },
  { kind: "link", href: "https://github.com/CristopherJmnz", icon: "fab fa-github", label: "GitHub" },
  { kind: "download", href: CvLink, icon: "fas fa-download", label: "Descargar CV", download: true }
];
